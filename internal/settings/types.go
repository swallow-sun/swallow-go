...
const (
	...
	SecretASRAliyunAPIKey      = "asr.aliyun.api_key"
	SecretASRSiliconFlowAPIKey = "asr.siliconflow.api_key"
	SecretTTSAPIKey            = "tts.api_key"
	SecretTTSAliyunAPIKey      = "tts.aliyun.api_key"
